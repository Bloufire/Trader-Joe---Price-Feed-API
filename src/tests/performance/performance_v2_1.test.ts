...
const api_url = `/v2_1/prices/0x9702230a8ea53601f5cd2dc00fdbc13d4df4a8c7/0xb97ef9ef8734c71904d8002f8b6bc66dd9c48a6e/1`; // USDT/USDC pair to make sure there is enough liquidity

describe("Performance Load Testing", () => {
    test("Total Response Time & Resquest per second - v2_1", async () => {
    ...
    test('P99 Response Time - v2_1', async () => {
        let responseTimes = [];
